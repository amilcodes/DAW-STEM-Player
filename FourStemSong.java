...
public class FourStemSong implements StemSongInterface{
    ...
    public FourStemSong(PApplet p, int SongVol){
        ...
        bassPlayer = bass.loadFile("C:\\Users\\Amil Agrawal\\OneDrive - Tredyffrin Easttown School District\\" +
                "JavaWorkspace\\FinalProj\\songs\\"+ SongVol +"\\Bass.mp3");
